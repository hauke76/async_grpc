...
if(NOT TARGET grpc++)
  ...
  message("======> look at THIS: ${grpc_STATIC_LIBRARIES}")
  ...
  # create the grpc++ target
  add_library(grpc++ UNKNOWN IMPORTED)
  set_target_properties(grpc++ PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${GRPC_INCLUDE_DIRS}")
  set_target_properties(grpc++ PROPERTIES IMPORTED_LOCATION "${grpc_STATIC_LIBRARIES}")
